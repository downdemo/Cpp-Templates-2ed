...
## [函数对象](https://zh.cppreference.com/w/cpp/named_req/FunctionObject)、[指针](https://zh.cppreference.com/w/cpp/language/pointer#.E6.8C.87.E5.90.91.E5.87.BD.E6.95.B0.E6.8C.87.E9.92.88)与[std::function](https://zh.cppreference.com/w/cpp/utility/functional/function)
...
* 为此需要使用 [std::function](https://zh.cppreference.com/w/cpp/utility/functional/function)
...
## 实现[std::function](https://zh.cppreference.com/w/cpp/utility/functional/function)

* [std::function](https://zh.cppreference.com/w/cpp/utility/functional/function) 是一个广义的函数指针形式，不同于函数指针的是，它能存储一个 lambda 或其他任何带有合适的 operator() 的函数对象。下面实现一个能替代 [std::function](https://zh.cppreference.com/w/cpp/utility/functional/function) 的类模板
